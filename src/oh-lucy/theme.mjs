export default ({ name, colors }) => ({
  ...
  colors: {
    ...
    'diffEditor.insertedTextBackground': colors.oh_translucentGreen1,
    "diffEditor.insertedLineBackground": colors.oh_translucentGreen2,
    "diffEditor.removedTextBackground": colors.oh_translucentRed1,
    "diffEditor.removedLineBackground": colors.oh_translucentRed2,
